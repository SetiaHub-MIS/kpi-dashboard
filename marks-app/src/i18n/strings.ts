...
export const STRINGS: Record<string, Record<Locale, string>> = {
  ...
  // -------------------------------------------------------------- role picker
  sign_in_intro: {
    ms: 'Log masuk dengan nombor pekerja. Paparan bergantung pada jawatan anda.',
    en: 'Sign in with your payroll number. What you see depends on your position.',
  },
  demo_intro: {
    ms: 'SV/AS dan Area Manager hanya melihat pekerja di cawangan mereka sendiri. Stor pusat di HQ menerima pulangan daripada setiap cawangan.',
  ...
  // ---------------------------------------------------------------------- gaps
  gaps_intro: {
    ms: '{gaps} daripada {total} kotak minggu × pekerja masih kosong.',
    en: '{gaps} of {total} week × staff cells are still empty.',
  },
  ...
  akaun_baharu_intro: {
    ms: 'Guna no. pekerja yang diberi HR — ia ikut cawangan dan jawatan, kekal, dan muncul pada setiap rekod.',
  ...
  kata_laluan_baharu_intro: {
    ms: 'Sekurang-kurangnya 6 aksara. Taip dua kali untuk pastikan.',
    en: 'At least 6 characters. Type it twice to be sure.',
  },
  sahkan_kata_laluan: { ms: 'Sahkan kata laluan', en: 'Confirm password' },
  simpan_kata_laluan: { ms: 'Simpan kata laluan', en: 'Save password' },
  kata_laluan_pendek: { ms: 'Kata laluan mesti sekurang-kurangnya 6 aksara.', en: 'Password must be at least 6 characters.' },
  kata_laluan_tak_sama: { ms: 'Kata laluan tidak sepadan.', en: 'Passwords do not match.' },
  kata_laluan_disimpan: { ms: 'Kata laluan disimpan', en: 'Password saved' },
  kata_laluan_disimpan_body: {
